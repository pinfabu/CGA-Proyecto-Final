...
void applicationLoop() {
	...
	while (psi) {
		...
		*******************************************/
		 ...
		 * State machines
		 *******************************************/
		cadena = "X" + std::to_string(hp);
		cadena1 = "X" + std::to_string(bullets);
		cadena2 = "X" + std::to_string(cobijas);
		cadena3 = "X" + std::to_string(cubre);
		if (hp > 0) {
<<<<<<< HEAD
...
>>>>>>> 5525a9edc21ee6e1e8182d8d4966b3d6fc54561f
			glfwSwapBuffers(window);
		}
		else {
